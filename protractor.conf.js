...
exports.config = {
    ...
    baseUrl:'https://beta-loanpro.simnang.com/client/app/login.html?',
    /**
     ...
     * value is false.
     *
     * CAUTION: This will cause your specs to slow down drastically.
     */
    ...
    cucumberOpts: {
        ...
        format: ['json:reports/test-results.json', './node_modules/cucumber-pretty']
    },
    /**
     ...
     * and may start the specs before preparation finishes.
     *
